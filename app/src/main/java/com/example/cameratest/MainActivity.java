...
public class MainActivity extends AppCompatActivity {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            Log.d(TAG, "图像可以用了 onImageAvailable");
            String picturePath = System.currentTimeMillis() + ".jpg";
            mFile = new File(Environment.getExternalStorageDirectory() + "/temp/", picturePath);
    ...
    private void initViews() {
        ...
        mFile = new File(Environment.getExternalStorageDirectory(), "temp/pic.jpg");
    }
...
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            //SurfaceTexture texture = new SurfaceTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES);
...
//                    }
    ...
    private void captureStillPicture() {
        Log.d(TAG, "into captureStillPicture");
        try {
    ...
    private void captureStillPicture1() {
        Log.d(TAG, "into captureStillPicture");
        try {
            final Activity activity = this;
            if (null == activity || null == mCameraDevice) {
